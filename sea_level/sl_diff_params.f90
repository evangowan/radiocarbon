program sl_diff_params
	...
	double precision :: score, maximum_elevation, minimum_elevation
...
!			write(6,*) trim(lab_id_array(id_counter)), time_array(time_counter), calc_sl_array(id_counter,time_counter)
	...
	if(file_exists) THEN
		...
		!		write(6,*) lab_id
				...
				write(out_unit,*) age, diff_elevation, age_range, diff_range, trim(lab_id)
